            ...
            parse(text) {
                ...
                for (var i = 0, l = lines.length; i < l; i++) {
                    ...
                    if (lineFirstChar === 'v') {
                        ...
                        const lineParts = line.substring(1)
                            .trim()
                            .split(' ');
                        let lineVertices = [];
                        ...
                        state.object.startMaterial(line.substring(7)
                            .trim(), state.materialLibraries);
                    } else if (material_library_pattern.test(line)) {
                        // mtl file

                        state.materialLibraries.push(line.substring(7)
                            .trim());
